import { LayoutDashboardIcon, ListCollapseIcon, ListIcon, PlusSquareIcon, EditIcon } from "lucide-react"
...
const AdminSidebar = () => {
  ...
  const adminNavLinks = [
    ...
    { name: 'Front page', path: '/admin/edit_hero-section', icon: EditIcon }
  ]
  return (
