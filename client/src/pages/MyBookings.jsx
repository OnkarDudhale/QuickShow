...
const MyBookings = () => {
  ...
  return !isLoading ? (
    <div className="relative px-6 md:px-16 lg:px-24 pt-30 md:pt-24 min-h-screen">
      <BlurCircle top="100px" left="100px" />
      <div>
        <BlurCircle bottom="0px" left="60px" />
      </div>
      {bookings.length === 0 ? (<p className="absolute inset-0 flex items-center justify-center">No Bookings Found</p>)
        : (
          < >
