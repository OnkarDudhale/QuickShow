...
const Dashboard = () => {
  ...
  const dashBoardCards = [
    ...
    { title: 'Active Shows', value: dashBoardData.length || '0', icon: PlayCircleIcon },
  ...
  return !loading ? (
    <>
      ...
      <div className="relative flex flex-wrap gap-6 mt-4 max-w-5xl">
        ...
        {dashBoardData.activeShows.length === 0 ? <p>No Active Shows Right Now</p> :
          dashBoardData.activeShows.map((show) => (
            <div key={show._id} className="w-54 rounded-lg overflow-hidden h-full pb-3 bg-primary/10 border border-primary/20 hover:-translate-y-1 transition duration-300">
